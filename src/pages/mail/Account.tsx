...
export function Account() {
    ...
    const { email, nome, senha } = queryResponse?.data?.usuario || {};
    ...
    return (
        <div className="mx-auto max-w-4xl w-full px-4 py-24 sm:px-6 sm:py-12 lg:px-8">
                        ...
                        <div className="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                            <div className="col-span-full">
                                ...
                                <div className="mt-2">
                                    <div className="flex items-center rounded-md">
                                        <div className="block min-w-0 grow py-1.5 pr-3 text-base text-gray-500 sm:text-sm/6">
                                            {email || ""}
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div className="col-span-full">
                                ...
                                <div className="mt-2 flex items-center gap-x-3">
                                    ...
                                    <button
                                        type="button"
                                        className="rounded-md bg-neutral-700 px-2.5 py-1.5 text-sm font-semibold text-white shadow-xs ring-1 ring-gray-300 ring-inset hover:bg-neutral-600 cursor-pointer"
                                    >
                                        Alterar
                                    </button>
                                </div>
                ...
                <div className="mt-6 flex items-center justify-between">
                    <div>
                        <button
                            ...
                            className="rounded-md bg-red-500 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-red-400 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
                        >
                            {deleteUserMutation.isPending
                                ? "Carregando..."
                                : "Excluir conta"}
                    ...
                    <div className="flex gap-x-6">
                        <button
                            type="button"
                            onClick={() => navigate(-1)}
                            className="rounded-md bg-neutral-700 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-neutral-600 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
                        >
                            Voltar
                        </button>
                        <button
                            ...
                            className="rounded-md bg-green-600 px-3 py-2 text-sm font-semibold text-white shadow-xs hover:bg-green-500 focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-blue-600 cursor-pointer"
                        >
                            {updateUserMutation.isPending
                                ? "Carregando..."
                                : "Salvar"}
